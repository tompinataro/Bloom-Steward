...
const styles = StyleSheet.create({
  ...
  stickyBar: { position: 'absolute', left: 0, right: 0, bottom: spacing(2), padding: spacing(2.5), paddingBottom: spacing(3), backgroundColor: colors.background, borderTopWidth: 1, borderTopColor: colors.border },
